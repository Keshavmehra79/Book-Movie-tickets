    ...
    return(
       ...
       <footer id="footer">
        <div className="sect">
            ...
            <div className="sec"><div className="iconfoot"><MdEmail       /></div> <Link style={{"textDecoration":"none"}}><h4>mehrakeshav332@gmail.com</h4></Link> </div>
        </div>

            <div className="sect">
              <h3 style={{"fontWeight":"bold","color":"white"}}>About the company</h3>
